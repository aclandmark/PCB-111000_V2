...
#define	digit_4			PORTB |= (1 << PB0)
#define	digit_5			PORTB |= (1 << PB2)
#define	digit_6			PORTB |= (1 << PB3)
#define	digit_7			PORTB |= (1 << PB4)
#define	toggle_digit_0	PORTB ^= (1 << PB4)

#define	digit_0		PORTB |= (1 << PB5)
#define	digit_1		PORTC |= (1 << PC0)
#define	digit_2		PORTC |= (1 << PC1)
#define	digit_3		PORTC |= (1 << PC2)
							...
							if (clock_buf[4] < '5') clock_buf[4]++;else {clock_buf[4] = '0';\
								switch (clock_buf[7]){\
									...
									#define decrement_minutes  if (clock_buf[3] > '0') clock_buf[3]--; else {clock_buf[3] = '9';\
										if (clock_buf[4] > '0') clock_buf[4]--;else {clock_buf[4] = '5';\
											switch (clock_buf[7]){\
												case '1': case '2': if (clock_buf[6] > '0') clock_buf[6]--; else {clock_buf[6] = '3';clock_buf[7]--;}break;\
