...
my_chartoa(radix, CHR, print_out_string); sendString_V(print_out_string);sendString(" ");}
...
if (sign_char == '-')
{sendChar('-'); sendString_V(print_out_string);sendString("  ");}
else {sendChar(' '); sendString_V(print_out_string);sendString("  ");}}
