...
//Prototypes required for "1_ATMEGA_Programmer_V2.25.c"
...
//Prototypes for "1_ATMEGA_Programmer_V2.25_SW_subs"
...
//Note: Prototype is not required for ISR(USART_RX_vect)
...
//Prototypes for "1_ATMEGA_Programmer_V2.25.h"
...
#define RBL 255
#define next_char; while (r_pointer == w_pointer)waitforchar();
...
/***********Main variables****************/
signed int PageSZ;
signed int PAmask;				//Page address mask
signed int FlashSZ;
signed int EEPROM;			
int text_start, text_start_mem;
unsigned char cmd_pin, resp_pin, clock_pin, reset_pin;// reset_only_pin;

//Variables for "1_ATMEGA_Programmer_V2.25_SW_subs"
...
int line_no;
signed int  read_ops=0, FF_cmd_counter_limit;
...
/*#define Text_Send_Text_File newline(); Read_on_chip_EEPROM(0x173); sendSpace();
...
#define Text_Send_file_again  Read_on_chip_EEPROM(0x1E2); sendSpace();
...
#define Text_SendEorAOK newline(); Read_on_chip_EEPROM(0x49);
#define Text_Send_Hex newline(); Read_on_chip_EEPROM(0x86);newline();*/
