...
while ((!(decimal_digit(keypress)))&& (keypress != '-'));				//Ignore non_decimal_char(keypress); 
digits[0] = keypress;
...
do
{keypress =  waitforkeypress();} 
while ((!(hex_digit(keypress)))&& (keypress != '-'));					//Ignore non_hex_char(keypress);
...
do
{keypress =  waitforkeypress();} 
while((!(decimal_digit(keypress)))&& (keypress != '-'));				// Ignore non_hex_char(keypress); 
