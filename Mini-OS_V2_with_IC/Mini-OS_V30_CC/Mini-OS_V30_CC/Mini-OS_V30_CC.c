...
# include "I2C_V30_0_CC_header_file.h"
# include "I2C_V30_0_CC_display_subroutines.c"
...
int main (void){
	...
	char *SW_Version = "System files: Mini-OS_V26_0_CC plus pcb_Bootloader_V4_28_CC \r\n";
